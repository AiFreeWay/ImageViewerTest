package testapplication.imageviewer.presentation.adapters

import android.support.v7.widget.RecyclerView
import android.view.ViewGroup
import testapplication.imageviewer.presentation.adapters.holders.BaseHolder
import java.util.*

/**
 * Created by root on 15.08.17.
 */
class MultyRvAdapter<M>(baseHolderTemplate: BaseHolder<M>) : RecyclerView.Adapter<BaseHolder<M>>() {
